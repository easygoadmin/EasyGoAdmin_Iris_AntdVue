...
func (c *Example2Controller) List(ctx iris.Context) {
	// 参数绑定
...
func (c *Example2Controller) Detail(ctx iris.Context) {
	// 记录ID
...
func (c *Example2Controller) Add(ctx iris.Context) {
	// 参数绑定
...
func (c *Example2Controller) Update(ctx iris.Context) {
	// 参数绑定
...
func (c *Example2Controller) Delete(ctx iris.Context) {
	// 记录ID
...
func (c *Example2Controller) Status(ctx iris.Context) {
	// 参数绑定
