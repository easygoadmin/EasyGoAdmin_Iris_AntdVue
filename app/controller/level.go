...
func (c *LevelController) Detail(ctx iris.Context) {
	// 记录ID
	...
	if id > 0 {
		...
		// 属性拷贝
		var levelInfoVo = &vo.LevelInfoVo{}
		utils.StructCopy(info, levelInfoVo)
...
func (c *LevelController) GetLevelList(ctx iris.Context) {
