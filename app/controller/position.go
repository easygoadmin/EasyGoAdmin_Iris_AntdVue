...
func (c *PositionController) List(ctx iris.Context) {
	// 查询对象
	...
	// 调用获取列表方法
	lists, count, err := service.Position.GetList(req)
	if err != nil {
		ctx.JSON(common.JsonResult{
			Code: -1,
			Msg:  err.Error(),
...
func (c *PositionController) Detail(ctx iris.Context) {
	// 记录ID
	...
	if id > 0 {
		...
		// 属性拷贝
		var positionInfoVo = &vo.PositionInfoVo{}
		utils.StructCopy(info, positionInfoVo)
...
func (c *PositionController) Add(ctx iris.Context) {
	// 添加对象
...
func (c *PositionController) Update(ctx iris.Context) {
	// 更新对象
...
func (c *PositionController) Delete(ctx iris.Context) {
	// 记录ID
...
func (c *PositionController) Status(ctx iris.Context) {
	// 设置对象
...
func (c *PositionController) GetPositionList(ctx iris.Context) {
	// 查询岗位列表
